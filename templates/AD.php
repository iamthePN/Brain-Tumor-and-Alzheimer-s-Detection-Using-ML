    ...
    <section ondragover="handleDragOver(event);" ondrop="handleDrop(event);">
        <article>
            ...
            <div id="inp">
                ...
                <form action="/predictAD" method="POST" enctype="multipart/form-data">
                    <input type="file" id="file-input" name="imgAD" accept="image/*" onchange="handleFileUpload(this.files)">
